...
<div class="container">
  ...
  <div class="footer">
    ...
    <div class="footer-row">
      <a
        class="author"
        href="https://github.com/alvinindra/figma-mcp-rust"
        target="_blank"
      >
        <img
          src="https://avatars.githubusercontent.com/u/30944414?v=4"
          alt="avatar"
        />
        alvinindra
      </a>
      <div class="links">
        <a
          class="footer-link"
          href="https://github.com/alvinindra/figma-mcp-rust/issues/new?labels=bug"
          target="_blank"
          title="Report a bug"
        >
        ...
        <a
          class="footer-link"
          href="https://github.com/alvinindra/figma-mcp-rust/issues/new?labels=enhancement&title=Feature+request%3A+"
          target="_blank"
